...
public class Population implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        customerTest();
        categoryTest();
        couponTestOne(adminFacade.getOneCompany(1)); //15
//        couponTestTwo(adminFacade.getOneCompany(1)); //5
        purchaseTestOne(adminFacade.getOneCustomer(1)); //15
...
//        try {adminFacade.addCompany(Company.builder().name("companyB").email("secondCompany").password("newPassword").build());}
//        catch (CouponRESTExceptionHandler e) {System.out.println(e.getText());}
//        try {adminFacade.addCompany(Company.builder().name("companyC").email("ccc").password("333").build());}
//        catch (CouponRESTExceptionHandler e) {System.out.println(e.getText());}
//
//        try {
...
//        try {adminFacade.addCustomer(Customer.builder().firstName("Bob").lastName("Bet").email("bbaa").password("22aa").build());}
//        catch (CouponRESTExceptionHandler e) {System.out.println(e.getText());}
//        try {adminFacade.addCustomer(Customer.builder().firstName("Clare").lastName("Gimel").email("cc").password("33").build());}
//        catch (CouponRESTExceptionHandler e) {System.out.println(e.getText());}
//
//        try {
...
//                .startDate(Date.valueOf("2021-08-06"))
...
//                .startDate(Date.valueOf("2021-08-10"))
...
//        } catch (CouponRESTExceptionHandler e) {System.out.println(e.getText());}
//
//        try {companyFacade.deleteCoupon(company, 2);} //35
//        catch (CouponRESTExceptionHandler e) {System.out.println(e.getText());}
//
